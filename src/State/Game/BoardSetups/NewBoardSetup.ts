...
Squares = [
  ...
  // Player 1: Back Row /==================
    ...
    new SquareModel( 5, 9, 2, new PieceModel( 1, PieceType.King, "Center", "OU")),
  ...
  // Player 1: Pawn Row /==================
  new SquareModel( 1, 7, 2, new PieceModel( 1, PieceType.Pawn, "9", "FU")),
  new SquareModel( 2, 7, 2, new PieceModel( 1, PieceType.Pawn, "8", "FU")),
  new SquareModel( 3, 7, 2, new PieceModel( 1, PieceType.Pawn, "7", "FU")),
  new SquareModel( 4, 7, 2, new PieceModel( 1, PieceType.Pawn, "6", "FU")),
  new SquareModel( 5, 7, 2, new PieceModel( 1, PieceType.Pawn, "5", "FU")),
  new SquareModel( 6, 7, 2, new PieceModel( 1, PieceType.Pawn, "4", "FU")),
  new SquareModel( 7, 7, 2, new PieceModel( 1, PieceType.Pawn, "3", "FU")),
  new SquareModel( 8, 7, 2, new PieceModel( 1, PieceType.Pawn, "2", "FU")),
  new SquareModel( 9, 7, 2, new PieceModel( 1, PieceType.Pawn, "1", "FU")),
  ...
  // Player 2: Back Row /==================
    ...
    new SquareModel( 5, 1, 1, new PieceModel( 2, PieceType.King, "Center", "GY")),
