...
Squares = [
  ...
  // Player 1: Back Row /==================
    new GameSquareModel( 1, 9, 2, new GamePieceModel( 1, GamePieceType.Lance, "Left", "0KY")),
    new GameSquareModel( 2, 9, 2, new GamePieceModel( 1, GamePieceType.Knight, "Left", "0KE")),
    new GameSquareModel( 3, 9, 2, new GamePieceModel( 1, GamePieceType.Silver, "Left", "0GI")),
    new GameSquareModel( 4, 9, 2, new GamePieceModel( 1, GamePieceType.Gold, "Left", "0KI")),
    new GameSquareModel( 5, 9, 2, new GamePieceModel( 1, GamePieceType.KingVictor, "Center", "0OU")),
    new GameSquareModel( 6, 9, 2, new GamePieceModel( 1, GamePieceType.Gold, "Right", "0KI")),
    new GameSquareModel( 7, 9, 2, new GamePieceModel( 1, GamePieceType.Silver, "Right", "0GI")),
    new GameSquareModel( 8, 9, 2, new GamePieceModel( 1, GamePieceType.Knight, "Right", "0KE")),
    new GameSquareModel( 9, 9, 2, new GamePieceModel( 1, GamePieceType.Lance, "Right", "0KY")),
    
    // Player 1: Mid Row /==================
    new GameSquareModel( 1, 8, 2 ),
    new GameSquareModel( 2, 8, 2, new GamePieceModel( 1, GamePieceType.Bishop, "Left", "0KA")),
    ...
    new GameSquareModel( 8, 8, 2, new GamePieceModel( 1, GamePieceType.Rook, "Right", "0HI")),
